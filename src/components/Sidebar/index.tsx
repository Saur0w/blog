    ...
    <aside className={styles.sidebar}>
      <nav className={styles.nav}>
        <ul className={styles.itemList}>
          ...
          <li className={styles.socialDropdown}>
            <button
              type="button"
              className={`${styles.itemLink} ${styles.socialTrigger} ${
                isSocialOpen ? styles.open : ""
              }`}
            ...
            <div
              className={`${styles.socialSublistWrapper} ${
                isSocialOpen ? styles.expanded : ""
              }`}
            >
              <div className={styles.socialSublist}>
